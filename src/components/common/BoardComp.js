      ...
      boardContent = (
        <div className="aboutme-container">
          ...
          <div className="aboutme-item-box">
            ...
            <p>
              처음 배웠을 땐 분명히 어려웠고 남들보다 이해하는 게 어려웠던 것
              같았습니다.
            </p>
            ...
            <p>
              그리고 인터넷에 떠 있는 광고를 보고 개발자에 대한 관심이 커지게
              되었습니다.
            </p>
            <p>코딩을 하며 문제를 해결하고 창의적인 결과물을 만드는 과정이</p>
            <p> 저를 코딩에 빠져들게 했습니다.</p>
            <p>
              그렇게 늦었지만, 개발자가 되기 위해 과감하게 전기설계를 그만두게
              되었습니다.
            </p>
            <p>그리고 지금은 개발자가 되기위해 도전하고 있습니다.</p>
          </div>
        </div>
      );
      break;
